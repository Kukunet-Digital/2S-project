      ...
      <header class="header black-bg">
          ...
          <section class="wrapper">
                <?php
                    ...
                    $grade = "SELECT * FROM school_grade where grade_id = '$grade_id'";
                    $r_grade = mysqli_query($con, $grade);
                    $row_grade = mysqli_fetch_assoc($r_grade);
                ...
                ?>
                        ...
                        <h4><i class="fa fa-angle-right"></i> Grade</h4>
                        <?php
                            if(isset($_POST['new']) && $_POST['new']){
                                $grade_name = $_REQUEST['grade_name'];

                                $update = "UPDATE school_grade SET grade_name = '$grade_name' where grade_id = '$grade_id'";
                            ...
                            <form action="edit_grade.php" method="post">
                                ...
                                <input type="text" name="grade_name" value="<?php echo $row_grade['grade_name']; ?>"><br>
