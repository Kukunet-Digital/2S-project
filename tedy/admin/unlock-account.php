...
<html lang="en">
  <head>
    ...
    <title>Admin | Unlock Account</title>
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Unlock Account </h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;"> The Unlock Account placed here</label>
